                                        ...
                                        <div class="received-chats" v-if="message.sender.uid !== uid">
                                            ...
                                            <div class="received-msg">
                                                <div class="received-msg-inbox">
                                                    <p><span>{{ message.sender.uid }}</span><span style="float:right; font-size: 0.7em;">12:34pm</span><br>{{ message.data.text }}</p>
                                                </div>
                                            </div>
                                        </div>
            ...
            sendGroupMessage() {
                ...
                CometChat.sendMessage(textMessage).then(
                    message => {
                        ...
                        this.$nextTick(() => {
                            // this.scrollToBottom()
                            $("#msg-page").animate({ scrollTop: $('#msg-page').prop("scrollHeight")}, 1000);
                        })
                    },
                    error => {
